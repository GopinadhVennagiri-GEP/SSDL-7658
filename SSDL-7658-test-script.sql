...
,('GEP_NORM_SPEND_USD','GEP Normalized Spend (USD)','GEP - Amount',@FloatDataTypeID,NULL,0,0,'ShowOnProjectSetupWorkflowUtilities',1,NULL,1,1,GETDATE(),1,GETDATE())
...
,('MODIFIED_DATE','Record Modifed Date','GEP - Admin - ID',@DatetimeDataTypeID,NULL,0,0,'ShowOnProjectSetupWorkflowUtilities',1,NULL,0,1,GETDATE(),1,GETDATE())
...
,('GEP_CLN_CLUSTER','GEP Classification Cluster ID','GEP - Admin - Maintenance',@intDataTypeID,NULL,0,0,'ShowOnProjectSetupWorkflowUtilities',1,NULL,0,1,GETDATE(),1,GETDATE())
...
,('IMPORTEXPORTUID1',NULL,'GEP - System',@intDataTypeID,NULL,0,0,'HideEverywhere',1,'System Internal field',0,1,GETDATE(),1,GETDATE())
,('IMPORTEXPORTUID2',NULL,'GEP - System',@intDataTypeID,NULL,0,0,'HideEverywhere',1,'System Internal field',0,1,GETDATE(),1,GETDATE())
,('IMPORTEXPORTUID3',NULL,'GEP - System',@intDataTypeID,NULL,0,0,'HideEverywhere',1,'System Internal field',0,1,GETDATE(),1,GETDATE())
,('IMPORTEXPORTUID4',NULL,'GEP - System',@intDataTypeID,NULL,0,0,'HideEverywhere',1,'System Internal field',0,1,GETDATE(),1,GETDATE())
,('IMPORTEXPORTUID5',NULL,'GEP - System',@intDataTypeID,NULL,0,0,'HideEverywhere',1,'System Internal field',0,1,GETDATE(),1,GETDATE())
,('IMPORTEXPORTUID6',NULL,'GEP - System',@intDataTypeID,NULL,0,0,'HideEverywhere',1,'System Internal field',0,1,GETDATE(),1,GETDATE())
,('IMPORTEXPORTUID7',NULL,'GEP - System',@intDataTypeID,NULL,0,0,'HideEverywhere',1,'System Internal field',0,1,GETDATE(),1,GETDATE())
,('IMPORTEXPORTUID8',NULL,'GEP - System',@intDataTypeID,NULL,0,0,'HideEverywhere',1,'System Internal field',0,1,GETDATE(),1,GETDATE())
,('IMPORTEXPORTUID9',NULL,'GEP - System',@intDataTypeID,NULL,0,0,'HideEverywhere',1,'System Internal field',0,1,GETDATE(),1,GETDATE())
,('IMPORTEXPORTUID10',NULL,'GEP - System',@intDataTypeID,NULL,0,0,'HideEverywhere',1,'System Internal field',0,1,GETDATE(),1,GETDATE())
