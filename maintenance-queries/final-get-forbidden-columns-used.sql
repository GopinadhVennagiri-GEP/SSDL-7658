...
INNER JOIN @ConfiguredJobs D ON A.JobId = D.JobId
-- UNION
-- SELECT DISTINCT 'Import Utility' AS Activity, A.ImportFileId AS JobId, '' AS JobName, '' AS StepOrTaskName, B.DisplayColumnName
...
-- UNION
-- SELECT DISTINCT 'Import Utility' AS Activity, C.ImportFileId AS JobId, '' AS JobName, '' AS StepOrTaskName, B.DisplayColumnName
